...
EOF
    ...
    pandoc "$mdfile" -o "$htmlfile" --css "$css_rel_path" --standalone --include-in-header="$ROOT_DIR/head.html" --metadata title="Hyfe CoughMonitor Suite (CMS) V3+ Evidence Dossier"
